...
{
    /// <summary>
    /// Veritabanýndaki BulguYonetimiCevap tablosu ile yazýlým arasýnda iliþki kurmamýzý saðlayan kalýcý nesnedir
    /// </summary>
    public class BulguYonetimiCevap : EntityBase, IEntity
    {
        ...
        [Column(TypeName = "int")]
        public int Tur { get; set; }//1 Eylem 2 Ýzleme Takip
