...
{
    /// <summary>
    /// Veritabanýndaki RiskEvreni tablosu ile yazýlým arasýnda iliþki kurmamýzý saðlayan kalýcý nesnedir
    /// </summary>
    public class RiskEvreni : EntityBase, IEntity
    {
        ...
        public virtual ViewKoordinatorluk RiskAzaltmaPlaniSorumluKoordinatorluk
        {
            get
            {
                ...
                //Listeleme (TabloDoldur kafa karýþtýrýyor. Orada sorumlu koordinatörlük gösteriyor (Azaltma varsa). Eðer null ise bu durumda koordinatörlük gösteriliyorki bu hatalý Melih 25.09.2023 (Risklerin Yönetilmesi - Listeleme ekranýnda Sorumlu Koordinatörlük ve Birim sütunlarýna da sýralama (aþaðý yukarý ok) koyabilir miyiz? Clickup maddesi)
        ...
        public virtual ViewBirim RiskAzaltmaPlaniSorumluBirim
        {
            get
            {
                ...
                //Listeleme (TabloDoldur kafa karýþtýrýyor. Orada sorumlu birim gösteriyor (Azaltma varsa). Eðer null ise bu durumda birim gösteriliyorki bu hatalý Melih 25.09.2023 (Risklerin Yönetilmesi - Listeleme ekranýnda Sorumlu Koordinatörlük ve Birim sütunlarýna da sýralama (aþaðý yukarý ok) koyabilir miyiz? Clickup maddesi)
