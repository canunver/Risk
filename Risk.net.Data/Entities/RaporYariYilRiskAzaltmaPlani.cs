...
{
    /// <summary>
    /// Veritabanındaki RaporYariYilRiskAzaltmaPlani view ile yazılım arasında ilişki kurmamızı sağlayan kalıcı nesnedir
    /// </summary>
    public class RaporYariYilRiskAzaltmaPlani : RaporEntityBase, IEntity
    {
        public int? Yil { get; set; }
        public int? Donem { get; set; }
        public string KoordinatorlukAdi { get; set; }
        public string BirimAdi { get; set; }
        public string SorumluKoordinatorlukAdi { get; set; }
        public string SorumluBirimAdi { get; set; }
