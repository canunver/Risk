...
namespace Risk.net.Data.DataContext
{
    ...
    {
        /// <summary>
        /// Veritabaný iþlemlerinin yapýldýðý DBContext sýnýfýnýn kurucularý deðiþtirilerek DbContextOptions türünden baðlantý ayarlarýný almaktadýr.
        /// </summary>
        ...
        /// <summary>
        /// Veritabaný baðlantý ayarlarý için kullanýlan metodtur.
        /// </summary>
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            else
            {
                ...
                //update-database ile mysql de table larý oluþturabilirsin
                //Mysql download indir kur (Server kurulacak)
                //DBeaver indir kur
                //database adý risk > schema risk oluþtur
                //insert cümlesi insert into olacak [], 'N ve dbo olmayacak noktalý virgülle bitecek
                //ör => INSERT INTO TanimBirim (Kod, Adi, Durum) VALUES ('F780B1C783B3480394DF3D19C2C65DEC', 'Ýç Denetim Koordinatörlüðü', 1);
        ...
        /// <summary>
        /// Veritabaný ilk defa oluþturulurken tetiklenen bir virtual metodtur, veritabaný tablolarý oluþturulmadan araya girer, tablo isimlerine müdahale edilebilir.
        /// View, Rapor Entity lerin veri tabanýnda fiziksel oluþturulmasý engellenir
        /// View, Rapor Entity lerin anahtar alanlarýnýn olmadýðý belirtilir
        /// </summary>
