...
{
    /// <summary>
    /// Yardim iþlemlerinin yapýldýðý sayfa
    /// </summary>
    public class YardimViewComponent : ViewComponent
    {
        ...
        /// <summary>
        /// <see cref="Risk.net.WebUI.ViewComponents.YardimViewComponent" /> 'ýn yeni bir örneðini baþlatan sýnýf
        /// </summary>
        ...
        /// <summary>
        /// Yardim ViewComponent sayfasý açýldýðýnda çalýþan metod.
        /// </summary>
