...
{
    /// <summary>
    /// DenetimGorevlendirme iþlemlerinin yapýldýðý sayfa
    /// </summary>
    [Authorize]
    ...
    public class DenetimGorevlendirmeViewComponent : ViewComponent
    {
        ...
        /// <summary>
        /// <see cref="Risk.net.WebUI.ViewComponents.DenetimGorevlendirmeViewComponent" /> 'ýn yeni bir örneðini baþlatan sýnýf
        /// </summary>
        ...
        /// <summary>
        /// DenetimGorevlendirme ViewComponent sayfasý açýldýðýnda çalýþan metod.
        /// </summary>
