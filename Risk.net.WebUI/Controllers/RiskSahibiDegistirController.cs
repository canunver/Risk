...
{
    /// <summary>
    /// Risk Sahibini Deðiþtir iþlemlerinin yapýldýðý sayfa
    /// </summary>
    [Authorize]
    ...
    {
        /// <summary>
        /// IRiskSahibiDegistirService servisine ulaþmak için kullanýlan deðiþken
        /// </summary>
        /// <remarks></remarks>
        private readonly IRiskSahibiDegistirService _service;

        /// <summary>
        /// <see cref="Risk.net.WebUI.Controllers.RiskSahibiDegistirController" /> 'ýn yeni bir örneðini baþlatan sýnýf
        /// </summary>
        ...
        /// <summary>
        /// RiskSahibiDegistir View sayfasý açýldýðýnda çalýþan metod
        /// </summary>
