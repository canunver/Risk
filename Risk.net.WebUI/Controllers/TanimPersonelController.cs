...
{
    /// <summary>
    /// Personel iþlemlerinin yapýldýðý sayfa
    /// </summary>
    [Authorize]
    public class TanimPersonelController : GenelController
    {
        ...
        /// <summary>
        /// <see cref="Risk.net.WebUI.Controllers.TanimPersonelController" /> 'ýn yeni bir örneðini baþlatan sýnýf
        /// </summary>
        ...
        /// <summary>
        /// TanimPersonel View sayfasý açýldýðýnda çalýþan metod. <see cref="Risk.net.WebUI.Classes.YetkiKontrol" /> metodu ile sayfayý görme yetkisi olan kullanýcýlar belirlenir
        /// </summary>
        ...
        /// <summary>
        /// Parametre olarak verilen kod ile uyuþan personelin unvan bilgisini veren metod
        /// </summary>
