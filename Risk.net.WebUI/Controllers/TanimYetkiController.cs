...
{
    /// <summary>
    /// Yetki iþlemlerinin yapýldýðý sayfa
    /// </summary>
    [Authorize]
    public class TanimYetkiController : GenelController
    {
        ...
        /// <summary>
        /// <see cref="Risk.net.WebUI.Controllers.TanimYetkiController" /> 'ýn yeni bir örneðini baþlatan sýnýf
        /// </summary>
        ...
        /// <summary>
        /// TanimYetki View sayfasý açýldýðýnda çalýþan metod. <see cref="Risk.net.WebUI.Classes.YetkiKontrol" /> metodu ile sayfayý görme yetkisi olan kullanýcýlar belirlenir
        /// </summary>
        ...
        /// <summary>
        /// Ekranlardaki Personel seçim kutularýnýn doldurulmasý için çaðrýlan metod
        /// </summary>
        /// <returns></returns>
        /// <remarks></remarks>
        [HttpPost]
        public async Task<IActionResult> SelectListesiVer(string koordinatorlukKod, string birimKod, string listeyeEklenecekPersonelkod = "", bool icDenetciGetir = false)
        {
            ...
            if (!string.IsNullOrWhiteSpace(koordinatorlukKod) || !string.IsNullOrWhiteSpace(birimKod))
            {
                ...
                foreach (var koor in koorlar)
                {
                    ...
                    var kriter = new ViewYetki() { KoordinatorlukKod = koor.Replace("_",""), BirimKod = "" };//Eðer tüm personel listenirse koordinatorlukKod='_' olarak gönderiliyor Melih 20.12.2023
        ...
        /// <summary>
        /// Ekranlardaki Ýç Kontrol Koordinatörlüðüne ait Personel seçim kutularýnýn doldurulmasý için çaðrýlan metod
        /// </summary>
        /// <returns></returns>
        /// <remarks></remarks>
        [HttpPost]
