...
{
    /// <summary>
    /// Denetim Eylem Plani iþlemlerinin yapýldýðý sayfa
    /// </summary>
    [Authorize]
    public class DenetimEylemPlaniController : GenelController
    {
        ...
        /// <summary>
        /// <see cref="Risk.net.WebUI.Controllers.DenetimEylemPlaniController" /> 'ýn yeni bir örneðini baþlatan sýnýf
        /// </summary>
        ...
        /// <summary>
        /// DenetimEylemPlani View sayfasý açýldýðýnda çalýþan metod. <see cref="Risk.net.WebUI.Classes.YetkiKontrol" /> metodu ile sayfayý görme yetkisi olan kullanýcýlar belirlenir
        /// </summary>
