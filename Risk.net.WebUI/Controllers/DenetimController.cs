...
{
    /// <summary>
    /// Denetim iþlemlerinin yapýldýðý sayfa
    /// </summary>
    [Authorize]
    public class DenetimController : GenelController
    {
        ...
        /// <summary>
        /// <see cref="Risk.net.WebUI.Controllers.DenetimController" /> 'ýn yeni bir örneðini baþlatan sýnýf
        /// </summary>
        ...
        /// <summary>
        /// IcDenetim View sayfasý açýldýðýnda çalýþan metod. <see cref="Risk.net.WebUI.Classes.YetkiKontrol" /> metodu ile sayfayý görme yetkisi olan kullanýcýlar belirlenir
        /// </summary>
        ...
        /// <summary>
        /// DisDenetim View sayfasý açýldýðýnda çalýþan metod. <see cref="Risk.net.WebUI.Classes.YetkiKontrol" /> metodu ile sayfayý görme yetkisi olan kullanýcýlar belirlenir
        /// </summary>
        [YetkiKontrol(Yetkiler = "ICDENETIMUZMANI,ICDENETIMKOORDINATOR,SISTEMYONETICISI")]//Yetki Tamam
        ...
        /// <summary>
        /// DenetimListe View sayfasý açýldýðýnda çalýþan metod. <see cref="Risk.net.WebUI.Classes.YetkiKontrol" /> metodu ile sayfayý görme yetkisi olan kullanýcýlar belirlenir
        /// </summary>
        ...
        /// <summary>
        /// Rapor No bilgisinin güncellenemesini saðlayan metod
        /// </summary>
        /// <param name="form"></param>
        /// <returns>
        /// Ok(sunucudan gelen Sonuc tipinde nesne)
        ...
        /// <summary>
        /// Ekranlardaki Denetim seçim kutularýnýn doldurulmasý için çaðrýlan metod
        /// </summary>
        /// <returns></returns>
        /// <remarks></remarks>
        [HttpPost]
