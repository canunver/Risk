...
{
    /// <summary>
    /// Denetim Ýzleme Takip iþlemlerinin yapýldýðý sayfa
    /// </summary>
    [Authorize]
    public class DenetimIzlemeTakipController : GenelController
    {
        ...
        /// <summary>
        /// <see cref="Risk.net.WebUI.Controllers.DenetimIzlemeTakipController" /> 'ýn yeni bir örneðini baþlatan sýnýf
        /// </summary>
        ...
        /// <summary>
        /// DenetimIzlemeTakip View sayfasý açýldýðýnda çalýþan metod. <see cref="Risk.net.WebUI.Classes.YetkiKontrol" /> metodu ile sayfayý görme yetkisi olan kullanýcýlar belirlenir
        /// </summary>
        ...
        /// <summary>
        /// Eylem Planý yazdýrma iþlemini yapan metod
        /// </summary>
        ...
        public async Task<FileContentResult> Yazdir(string denetimKod, string ciktiTur)
        {
            ...
            foreach (BulguYonetimiCevap item in sonucCevap.Liste)
            {
                ...
                XLS.HucreDegerYaz(satir, 6, item.BulguYonetimi.EylemKarsilama == 1 ? "Evet" : "Hayýr");
