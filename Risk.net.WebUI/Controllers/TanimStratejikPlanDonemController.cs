...
{
    /// <summary>
    /// Stratejik Plan Dönemleri tanýmlama iþlemlerinin yapýldýðý sayfa
    /// </summary>
    [Authorize]
    public class TanimStratejikPlanDonemController : GenelController
    {
        /// <summary>
        /// ITanimStratejikPlanDonemService servisine ulaþmak için kullanýlan deðiþken
        /// </summary>
        /// <remarks></remarks>
        private readonly ITanimStratejikPlanDonemService _service;

        /// <summary>
        /// <see cref="Risk.net.WebUI.Controllers.TanimStratejikPlanDonemController" /> 'ýn yeni bir örneðini baþlatan sýnýf
        /// </summary>
