...
{
    /// <summary>
    /// Home iþlemlerinin yapýldýðý sayfa
    /// </summary>
    [Authorize]
    public class HomeController : GenelController
    {
        /// <summary>
        /// IGrafikService servisine ulaþmak için kullanýlan deðiþken
        /// </summary>
        /// <remarks></remarks>
        ...
        /// <summary>
        /// <see cref="Risk.net.WebUI.Controllers.HomeController" /> 'ýn yeni bir örneðini baþlatan sýnýf
        /// </summary>
        ...
        /// <summary>
        /// Home View sayfasý açýldýðýnda çalýþan metod.
        /// </summary>
        ...
        /// <summary>
        /// Kullanýcýdan gelen kriterlere göre bulgu durumunu ilgili servis aracýlýðýyla getiren metod
        /// </summary>
        /// <param name="form"></param>
        /// <returns>
        /// Ok(sunucudan gelen Sonuc tipinde nesne)
        ...
        /// <summary>
        /// Kullanýcýdan gelen kriterlere göre süreç için gereken bilgiyi ilgili servis aracýlýðýyla getiren metod
        /// </summary>
        /// <param name="form"></param>
        /// <returns>
        /// Ok(sunucudan gelen Sonuc tipinde nesne)
        ...
        /// <summary>
        /// Kullanýcýdan gelen kriterlere göre bulgu önem düzeyini ilgili servis aracýlýðýyla getiren metod
        /// </summary>
        /// <param name="form"></param>
        /// <returns>
        /// Ok(sunucudan gelen Sonuc tipinde nesne)
        ...
        /// <summary>
        /// Kullanýcýdan gelen kriterlere göre yapýsal risk seviyesini ilgili servis aracýlýðýyla getiren metod
        /// </summary>
        /// <param name="form"></param>
        /// <returns>
        /// Ok(sunucudan gelen Sonuc tipinde nesne)
        ...
        /// <summary>
        /// Kullanýcýdan gelen kriterlere göre artýk risk seviyesini ilgili servis aracýlýðýyla getiren metod
        /// </summary>
        /// <param name="form"></param>
        /// <returns>
        /// Ok(sunucudan gelen Sonuc tipinde nesne)
        ...
        /// <summary>
        /// Kullanýcýdan gelen kriterlere göre risk puanýný ilgili servis aracýlýðýyla getiren metod
        /// </summary>
        /// <param name="form"></param>
        /// <returns>
        /// Ok(sunucudan gelen Sonuc tipinde nesne)
        ...
        /// <summary>
        /// Kullanýcýdan gelen kriterlere göre risk kategorilerini ilgili servis aracýlýðýyla getiren metod
        /// </summary>
        /// <param name="form"></param>
        /// <returns>
        /// Ok(sunucudan gelen Sonuc tipinde nesne)
        ...
        /// <summary>
        /// Kullanýcý ekrandan dil deðiþikliði yaptýðýnda cookie ye dil ile iligli bilgileri yazan metod
        /// </summary>
        ...
        /// <summary>
        /// Kullanýcýdan gelen kriterlere göre performans izleme paneli için gereken bilgiyi ilgili servis aracýlýðýyla getiren metod
        /// </summary>
        /// <param name="form"></param>
        /// <returns>
        /// Ok(sunucudan gelen Sonuc tipinde nesne)
        ...
        /// <summary>
        /// Kullanýcýdan gelen kriterlere göre KRITolerans grafiði için gereken bilgiyi ilgili servis aracýlýðýyla getiren metod
        /// </summary>
        /// <param name="form"></param>
        /// <returns>
        /// Ok(sunucudan gelen Sonuc tipinde nesne)
        ...
        /// <summary>
        /// Kullanýcýdan gelen kriterlere göre KRIToleransPie grafiði için gereken bilgiyi ilgili servis aracýlýðýyla getiren metod
        /// </summary>
        /// <param name="form"></param>
        /// <returns>
        /// Ok(sunucudan gelen Sonuc tipinde nesne)
