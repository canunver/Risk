...
{
    /// <summary>
    /// Risk kategorilerinin tanımlama işlemlerinin yapıldığı sayfa
    /// </summary>
    [Authorize]
    public class TanimRiskKategoriController : GenelController
    {
        /// <summary>
        /// ITanimRiskKategoriService servisine ulaşmak için kullanılan değişken
        /// </summary>
        /// <remarks></remarks>
        private readonly ITanimRiskKategoriService _service;

        /// <summary>
        /// <see cref="Risk.net.WebUI.Controllers.TanimRiskKategoriController" /> 'ın yeni bir örneğini başlatan sınıf
        /// </summary>
        /// <param name="service"></param>
        /// <param name="httpContextAccessor"></param>
        /// <param name="sharedResource"></param>
        /// <remarks></remarks>
        public TanimRiskKategoriController(ITanimRiskKategoriService service,
        ...
        /// <summary>
        /// TanimRiskKategori View sayfası açıldığında çalışan metod
        /// </summary>
        ...
        /// </returns>
        [HttpPost]
        public async Task<ActionResult> Kaydet([FromBody] TanimRiskKategori form)
        {
        ...
        {
            TanimRiskKategori form = new TanimRiskKategori();
            form.Kod = kod;
        ...
        public async Task<IActionResult> SelectListesiVer()
        {
            ...
            foreach (TanimRiskKategori item in sonuc.Liste)
            {
