...
{
    /// <summary>
    /// Risk kategorilerinin tanýmlama iþlemlerinin yapýldýðý sayfa
    /// </summary>
    [Authorize]
    public class TanimRiskKategoriController : GenelController
    {
        /// <summary>
        /// ITanimRiskKategoriService servisine ulaþmak için kullanýlan deðiþken
        /// </summary>
        /// <remarks></remarks>
        private readonly ITanimRiskKategoriService _service;

        /// <summary>
        /// <see cref="Risk.net.WebUI.Controllers.TanimRiskKategoriController" /> 'ýn yeni bir örneðini baþlatan sýnýf
        /// </summary>
        ...
        /// <summary>
        /// TanimRiskKategori View sayfasý açýldýðýnda çalýþan metod
        /// </summary>
