...
{
    /// <summary>
    /// StratejikPlan iþlemlerinin yapýldýðý sayfa
    /// </summary>
    [Authorize]
    public class StratejikPlanController : GenelController
    {
        /// <summary>
        /// IStratejikPlanService servisine ulaþmak için kullanýlan deðiþken
        /// </summary>
        /// <remarks></remarks>
        ...
        /// <summary>
        /// <see cref="Risk.net.WebUI.Controllers.StratejikPlanController" /> 'ýn yeni bir örneðini baþlatan sýnýf
        /// </summary>
        ...
        /// <summary>
        /// StratejikPlan View sayfasý açýldýðýnda çalýþan metod. <see cref="Risk.net.WebUI.Classes.YetkiKontrol" /> metodu ile sayfayý görme yetkisi olan kullanýcýlar belirlenir
        /// </summary>
        ...
        /// <summary>
        /// Ekranlardaki Amac seçim kutularýnýn doldurulmasý için çaðrýlan metod
        /// </summary>
        ...
        {
            //Koordinatorlüðe göre listelenmesin
        ...
        /// <summary>
        /// Ekranlardaki Hedef seçim kutularýnýn doldurulmasý için çaðrýlan metod
        /// </summary>
        /// <returns></returns>
        /// <remarks></remarks>
        [HttpPost]
        ...
        /// <summary>
        /// Ekranlardaki Gosterge seçim kutularýnýn doldurulmasý için çaðrýlan metod
        /// </summary>
        /// <returns></returns>
        /// <remarks></remarks>
        [HttpPost]
