...
{
    /// <summary>
    /// TanimRiskKategori işlemlerinin yapıldığı servisin arayüzü
    /// </summary>
    public interface ITanimRiskKategoriService
    {
        /// <summary>
        ...
        /// Sonuc nesnesi döndürür
        /// </returns>
        Task<Sonuc> KaydetAsync(KullaniciDto kullanan, TanimRiskKategori gelenNesne);
        /// <summary>
        ...
        /// Sonuc nesnesi döndürür
        /// </returns>
        Task<Sonuc> DurumDegistirAsync(KullaniciDto kullanan, TanimRiskKategori gelenNesne);
    }
}
