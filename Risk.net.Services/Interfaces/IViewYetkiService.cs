...
{
    /// <summary>
    /// ViewYetki iþlemlerinin yapýldýðý servisin arayüzü
    /// </summary>
    public interface IViewYetkiService
    {
        /// <summary>
        ...
        /// Sonuc nesnesi döndürür
        /// </returns>
        Task<Sonuc> ListeleAsync(KullaniciDto kullanan, ViewYetki kriter);
        /// <summary>
        /// Istemciden parametre ile talep edilen bilgilere ait kayýtlarýn listesini döndüren metodun arayüzü
        /// </summary>
        /// <param name="kullanan"></param>
        ...
        /// <summary>
        /// Istemciden parametre ile talep edilen bilgilere ait mail listesini döndüren metodun arayüzü
        /// </summary>
        /// <param name="kullanan"></param>
        /// <param name="kriter"></param>
        /// <returns>
        /// Sonuc nesnesi döndürür
        /// </returns>
        Task<Sonuc> ListeleMailAsync(KullaniciDto kullanan, ViewYetki kriter);
    }
}
