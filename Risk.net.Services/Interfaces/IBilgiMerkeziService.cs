...
{
    /// <summary>
    /// BilgiMerkezi iþlemlerinin yapýldýðý servisin arayüzü
    /// </summary>
    public interface IBilgiMerkeziService
    {
        /// <summary>
        ...
        /// Sonuc nesnesi döndürür
        /// </returns>
        Task<Sonuc> KaydetAsync(KullaniciDto kullanan, BilgiMerkezi gelenNesne);
        /// <summary>
        ...
        /// Sonuc nesnesi döndürür
        /// </returns>
        Task<Sonuc> DurumDegistirAsync(KullaniciDto kullanan, string kod, int durum);
    }
}
