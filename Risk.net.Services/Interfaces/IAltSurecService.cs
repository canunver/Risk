...
{
    /// <summary>
    /// AltSurec iþlemlerinin yapýldýðý servisin arayüzü
    /// </summary>
    public interface IAltSurecService
    {
        /// <summary>
        ...
        /// Sonuc nesnesi döndürür
        /// </returns>
        Task<Sonuc> ListeleAsync(KullaniciDto kullanan, string surecKod, int durumKod);
        /// <summary>
        /// Istemciden parametre ile talep edilen bilgilere ait kayýtlarýn listesini döndüren metodun arayüzü
        /// </summary>
        /// <param name="kullanan"></param>
        ...
        /// Sonuc nesnesi döndürür
        /// </returns>
        Task<Sonuc> KaydetAsync(KullaniciDto kullanan, AltSurec gelenNesne);
        /// <summary>
        ...
        /// Sonuc nesnesi döndürür
        /// </returns>
        Task<Sonuc> SilAsync(KullaniciDto kullanan, string surecKod);
        /// <summary>
        ...
        /// Sonuc nesnesi döndürür
        /// </returns>
        Task<Sonuc> DurumDegistirAsync(KullaniciDto kullanan, AltSurec gelenNesne);
    }
}
