...
{
    /// <summary>
    /// TanimOlayKategori iþlemlerinin yapýldýðý servisin arayüzü
    /// </summary>
    public interface ITanimOlayKategoriService
    {
        /// <summary>
        ...
        /// Sonuc nesnesi döndürür
        /// </returns>
        Task<Sonuc> KaydetAsync(KullaniciDto kullanan, TanimOlayKategori gelenNesne);
        /// <summary>
        ...
        /// Sonuc nesnesi döndürür
        /// </returns>
        Task<Sonuc> DurumDegistirAsync(KullaniciDto kullanan, TanimOlayKategori gelenNesne);
    }
}
