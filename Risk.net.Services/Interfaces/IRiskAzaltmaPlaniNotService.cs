...
{
    /// <summary>
    /// RiskAzaltmaPlaniNot işlemlerinin yapıldığı servisin arayüzü
    /// </summary>
    public interface IRiskAzaltmaPlaniNotService
    {
        /// <summary>
        ...
        /// Sonuc nesnesi döndürür
        /// </returns>
        Task<Sonuc> KaydetAsync(KullaniciDto kullanan, RiskAzaltmaPlaniNot gelenNesne);
        /// <summary>
        ...
        /// Sonuc nesnesi döndürür
        /// </returns>
        Task<Sonuc> DurumDegistirAsync(KullaniciDto kullanan, RiskAzaltmaPlaniNot gelenNesne);
    }
}
