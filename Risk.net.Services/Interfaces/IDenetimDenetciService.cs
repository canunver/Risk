...
{
    /// <summary>
    /// DenetimDenetci iþlemlerinin yapýldýðý servisin arayüzü
    /// </summary>
    public interface IDenetimDenetciService
    {
        /// <summary>
        ...
        /// Sonuc nesnesi döndürür
        /// </returns>
        Task<Sonuc> KaydetAsync(KullaniciDto kullanan, DenetimDenetci gelenNesne);
        /// <summary>
