...
{
    /// <summary>
    /// RiskAzaltmaPlaniIliski iþlemlerinin yapýldýðý servisin arayüzü
    /// </summary>
    public interface IRiskAzaltmaPlaniIliskiService
    {
        /// <summary>
        ...
        /// Sonuc nesnesi döndürür
        /// </returns>
        Task<Sonuc> KaydetAsync(KullaniciDto kullanan, RiskAzaltmaPlaniIliski gelenNesne);
        /// <summary>
