...
{
    /// <summary>
    /// RiskEvreniOlayKategori işlemlerinin yapıldığı servisin arayüzü
    /// </summary>
    public interface IRiskEvreniOlayKategoriService
    {
        /// <summary>
        ...
        /// Sonuc nesnesi döndürür
        /// </returns>
        Task<Sonuc> KaydetAsync(KullaniciDto kullanan, RiskEvreniOlayKategori gelenNesne);
        /// <summary>
