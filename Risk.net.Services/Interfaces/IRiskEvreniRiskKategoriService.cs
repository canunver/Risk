...
{
    /// <summary>
    /// RiskEvreniRiskKategori işlemlerinin yapıldığı servisin arayüzü
    /// </summary>
    public interface IRiskEvreniRiskKategoriService
    {
        /// <summary>
        ...
        /// Sonuc nesnesi döndürür
        /// </returns>
        Task<Sonuc> KaydetAsync(KullaniciDto kullanan, RiskEvreniRiskKategori gelenNesne);
        /// <summary>
