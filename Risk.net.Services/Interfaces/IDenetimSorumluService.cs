...
{
    /// <summary>
    /// DenetimSorumlu işlemlerinin yapıldığı servisin arayüzü
    /// </summary>
    public interface IDenetimSorumluService
    {
        /// <summary>
        ...
        /// Sonuc nesnesi döndürür
        /// </returns>
        Task<Sonuc> KaydetAsync(KullaniciDto kullanan, DenetimSorumlu gelenNesne);
        /// <summary>
