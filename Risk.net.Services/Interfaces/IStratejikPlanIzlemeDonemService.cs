...
{
    /// <summary>
    /// StratejikPlanIzlemeGostergeDonem iþlemlerinin yapýldýðý servisin arayüzü
    /// </summary>
    public interface IStratejikPlanIzlemeDonemService
    {
        /// <summary>
        ...
        /// Sonuc nesnesi döndürür
        /// </returns>
        Task<Sonuc> ListeleAsync(KullaniciDto kullanan, string stratejikPlanIzlemeGostergeKod);
        /// <summary>
        /// Istemciden parametre ile talep edilen bilgilere ait kayýtlarýn listesini döndüren metodun arayüzü
        /// </summary>
        /// <param name="kullanan"></param>
        ...
        /// Sonuc nesnesi döndürür
        /// </returns>
        Task<Sonuc> KaydetAsync(KullaniciDto kullanan, StratejikPlanIzlemeDonem gelenNesne);
        /// <summary>
        ...
        /// Sonuc nesnesi döndürür
        /// </returns>
        Task<Sonuc> SilAsync(KullaniciDto kullanan, StratejikPlanIzlemeDonem gelenNesne);
    }
}
