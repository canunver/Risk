...
{
    /// <summary>
    /// Mail Tarihce iþlemlerinin yapýldýðý servisin arayüzü
    /// </summary>
    public interface IMailTarihceService
    {
        /// <summary>
        ...
        /// Sonuc nesnesi döndürür
        /// </returns>
        Task<Sonuc> KaydetAsync(KullaniciDto kullanan, MailTarihce gelenNesne);
