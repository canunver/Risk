...
{
    /// <summary>
    /// RiskEvreniOlayRaporlama iþlemlerinin yapýldýðý servisin arayüzü
    /// </summary>
    public interface IRiskEvreniOlayRaporlamaService
    {
        /// <summary>
        ...
        /// </summary>
        /// <param name="kullanan"></param>
        /// <param name="olayKod"></param>
        /// <returns>
        /// Sonuc nesnesi döndürür
        /// </returns>
        Task<Sonuc> ListeleAsync(KullaniciDto kullanan, string olayKod);
        /// <summary>
        /// Istemciden parametre ile talep edilen bilgilere ait kayýtlarýn listesini döndüren metodun arayüzü
        /// </summary>
        /// <param name="kullanan"></param>
        ...
        /// Sonuc nesnesi döndürür
        /// </returns>
        Task<Sonuc> KaydetAsync(KullaniciDto kullanan, RiskEvreniOlayRaporlama gelenNesne);
        /// <summary>
        ...
        /// Sonuc nesnesi döndürür
        /// </returns>
        Task<Sonuc> SilAsync(KullaniciDto kullanan, string riskEvreniKod);
    }
}
