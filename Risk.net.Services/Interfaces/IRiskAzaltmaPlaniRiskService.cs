...
{
    /// <summary>
    /// RiskAzaltmaPlaniRisk işlemlerinin yapıldığı servisin arayüzü
    /// </summary>
    public interface IRiskAzaltmaPlaniRiskService
    {
        /// <summary>
        ...
        /// Sonuc nesnesi döndürür
        /// </returns>
        Task<Sonuc> KaydetAsync(KullaniciDto kullanan, RiskAzaltmaPlaniRisk gelenNesne);
        /// <summary>
