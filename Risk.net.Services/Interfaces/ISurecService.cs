...
{
    /// <summary>
    /// Surec iþlemlerinin yapýldýðý servisin arayüzü
    /// </summary>
    public interface ISurecService
    {
        ...
        /// Sonuc nesnesi döndürür
        /// </returns>
        Task<Sonuc> ListeleAsync(KullaniciDto kullanan, string koordinatorlukKod, string birimKod, int durumKod);
        /// <summary>
        /// Istemciden parametre ile talep edilen bilgilere ait kayýtlarýn listesini döndüren metodun arayüzü
        /// </summary>
        /// <param name="kullanan"></param>
        ...
        /// Sonuc nesnesi döndürür
        /// </returns>
        Task<Sonuc> KaydetAsync(KullaniciDto kullanan, Surec gelenNesne);
        /// <summary>
        ...
        /// Sonuc nesnesi döndürür
        /// </returns>
        Task<Sonuc> DurumDegistirAsync(KullaniciDto kullanan, Surec gelenNesne);
    }
}
