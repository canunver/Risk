...
{
    /// <summary>
    /// TanimStratejikPlanDonem iþlemlerinin yapýldýðý servisin arayüzü
    /// </summary>
    public interface ITanimStratejikPlanDonemService
    {
        /// <summary>
        ...
        /// Sonuc nesnesi döndürür
        /// </returns>
        Task<Sonuc> KaydetAsync(KullaniciDto kullanan, TanimStratejikPlanDonem gelenNesne);
        /// <summary>
        ...
        /// Sonuc nesnesi döndürür
        /// </returns>
        Task<Sonuc> DurumDegistirAsync(KullaniciDto kullanan, TanimStratejikPlanDonem gelenNesne);
    }
}
