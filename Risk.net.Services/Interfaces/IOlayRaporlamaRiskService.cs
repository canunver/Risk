...
{
    /// <summary>
    /// OlayRaporlamaRisk işlemlerinin yapıldığı servisin arayüzü
    /// </summary>
    public interface IOlayRaporlamaRiskService
    {
        /// <summary>
        ...
        /// Sonuc nesnesi döndürür
        /// </returns>
        Task<Sonuc> KaydetAsync(KullaniciDto kullanan, OlayRaporlamaRisk gelenNesne);
        /// <summary>
