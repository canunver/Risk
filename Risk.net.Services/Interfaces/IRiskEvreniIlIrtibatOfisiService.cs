...
{
    /// <summary>
    /// RiskEvreniIlIrtibatOfisi iþlemlerinin yapýldýðý servisin arayüzü
    /// </summary>
    public interface IRiskEvreniIlIrtibatOfisiService
    {
        /// <summary>
        ...
        /// Sonuc nesnesi döndürür
        /// </returns>
        Task<Sonuc> ListeleAsync(KullaniciDto kullanan, string riskEvreniKod);
        /// <summary>
        /// Istemciden parametre ile talep edilen bilgilere ait kayýtlarýn listesini döndüren metodun arayüzü
        /// </summary>
        /// <param name="kullanan"></param>
        ...
        /// Sonuc nesnesi döndürür
        /// </returns>
        Task<Sonuc> KaydetAsync(KullaniciDto kullanan, RiskEvreniIlIrtibatOfisi gelenNesne);
        /// <summary>
