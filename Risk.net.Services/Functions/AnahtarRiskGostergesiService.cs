...
{
    /// <summary>
    /// AnahtarRiskGostergesi iþlemlerinin yapýldýðý servis
    /// </summary>
    public class AnahtarRiskGostergesiService : IAnahtarRiskGostergesiService
    {
        ...
        /// <summary>
        /// IUnitOfWork<AnahtarRiskGostergesi> servisine ulaþmak için kullanýlan deðiþken
        /// </summary>
        /// <remarks></remarks>
        ...
        /// <summary>
        /// <see cref="Risk.net.Services.Functions.AnahtarRiskGostergesiService" /> 'ýn yeni bir örneðini baþlatan sýnýf
        /// </summary>
        ...
        public async Task<object> TabloDoldurAsync(KullaniciDto kullanan, DataTablesParam dataTablesParam)
        {
            ...
            */
            ...
            if (aramaDegeri.StartsWith("GELISMIS_ARAMA:"))
            {
                ...
                //Anahtar Risk Göstergesi boþ olan kayýtlarý aranmak için
        ...
        public async Task<Sonuc> KaydetAsync(KullaniciDto kullanan, AnahtarRiskGostergesi gelenNesne)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    //ARG deðeri kýrmýzý deðerin üzerine çýkarsa ilgili merkez/il koordinatörüne bildirim düþer. (Detay açýklamada)
                    if (kontrolKayit?.RiskYonetimi?.Durum == (int)ENUMDurum.Onayli && durum == "KIRMIZI" && eskiKayit.DurumDeger != "KIRMIZI") //Kýrmýzý renge dönüþtü
                    {
                        bildirimDurum = (int)ENUMBildirimSistemiDurum.ARGDegeriKirmiziDegerinUzerineCikti;
                        bildirimAciklama = "{RiskNo} numaralý riskin anahtar risk göstergesi durumu " + durum + " deðere çýkmýþtýr.";
                    }
                    //----------------------------------------------------------------------------------------------------
                ...
                //Riks Evreni AnahtarRiskGostergesi alaný güncellensin. https://app.clickup.com/t/86932nx0k
