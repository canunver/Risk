...
{
    /// <summary>
    /// TanimOlayKategori işlemlerinin yapıldığı servis
    /// </summary>
    public class TanimOlayKategoriService : ITanimOlayKategoriService
    {
        /// <summary>
        /// IUnitOfWork<TanimOlayKategori> servisine ulaşmak için kullanılan değişken
        /// </summary>
        /// <remarks></remarks>
        ...
        /// <summary>
        /// <see cref="Risk.net.Services.Functions.TanimOlayKategoriService" /> 'ın yeni bir örneğini başlatan sınıf
        /// </summary>
