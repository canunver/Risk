...
{
    /// <summary>
    /// TanimOlayKategori iþlemlerinin yapýldýðý servis
    /// </summary>
    public class TanimOlayKategoriService : ITanimOlayKategoriService
    {
        /// <summary>
        /// IUnitOfWork<TanimOlayKategori> servisine ulaþmak için kullanýlan deðiþken
        /// </summary>
        /// <remarks></remarks>
        private readonly IUnitOfWork<TanimOlayKategori> _unitOfWork;
        /// <summary>
        ...
        /// <summary>
        /// <see cref="Risk.net.Services.Functions.TanimOlayKategoriService" /> 'ýn yeni bir örneðini baþlatan sýnýf
        /// </summary>
        /// <param name="unitOfWork"></param>
        /// <param name="sharedResource"></param>
        /// <remarks></remarks>
        public TanimOlayKategoriService(IUnitOfWork<TanimOlayKategori> unitOfWork, IStringLocalizer<CustomResource> sharedResource)
        {
        ...
        public async Task<object> TabloDoldurAsync(KullaniciDto kullanan, DataTablesParam dataTablesParam)
        {
            ...
            {
                TanimOlayKategori aramaObj = Arac.DataTablesAramaNesne<TanimOlayKategori>(new TanimOlayKategori(), aramaDegeri);
        ...
        /// Sonuc nesnesi döndürür
        /// </returns>
        public async Task<Sonuc> KaydetAsync(KullaniciDto kullanan, TanimOlayKategori gelenNesne)
        {
            TanimOlayKategori islemYapilan = new TanimOlayKategori();
        ...
        /// Sonuc nesnesi döndürür
        /// </returns>
        public async Task<Sonuc> DurumDegistirAsync(KullaniciDto kullanan, TanimOlayKategori gelenNesne)
        {
            TanimOlayKategori islemYapilan = new TanimOlayKategori();
