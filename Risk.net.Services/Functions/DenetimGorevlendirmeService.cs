...
{
    /// <summary>
    /// DenetimGorevlendirme iþlemlerinin yapýldýðý servis
    /// </summary>
    public class DenetimGorevlendirmeService : IDenetimGorevlendirmeService
    {
        /// <summary>
        /// IUnitOfWork<DenetimGorevlendirme> servisine ulaþmak için kullanýlan deðiþken
        /// </summary>
        /// <remarks></remarks>
        ...
        /// <summary>
        /// <see cref="Risk.net.Services.Functions.DenetimGorevlendirmeService" /> 'ýn yeni bir örneðini baþlatan sýnýf
        /// </summary>
        ...
        public async Task<Sonuc> KaydetAsync(KullaniciDto kullanan, DenetimGorevlendirme gelenNesne)
        {
            ...
            try
            {
                if (!Arac.YetkisiVarmi("ICDENETIMKOORDINATOR", kullanan))
                {
                    ...
                    if (!bulundu)
                        return new Sonuc(ENUMIslemDurum.Hata, "Kaydetme için yetkiniz yok. Kayýt iþlemini, ilgili denetimde görevli kiþiler yapabilir.");
                }
