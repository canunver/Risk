...
namespace Risk.net.Services.Functions
{
    ...
    /// </summary>
    public class RiskEvreniRiskKategoriService : IRiskEvreniRiskKategoriService
    {
        /// <summary>
        /// IUnitOfWork<RiskEvreniRiskKategori> servisine ulaþmak için kullanýlan deðiþken
        /// </summary>
        /// <remarks></remarks>
        private readonly IUnitOfWork<RiskEvreniRiskKategori> _unitOfWork;
        /// <summary>
        ...
        /// <summary>
        /// <see cref="Risk.net.Services.Functions.RiskEvreniRiskKategoriService" /> 'ýn yeni bir örneðini baþlatan sýnýf
        /// </summary>
        /// <param name="unitOfWork"></param>
        /// <param name="sharedResource"></param>
        /// <remarks></remarks>
        public RiskEvreniRiskKategoriService(IUnitOfWork<RiskEvreniRiskKategori> unitOfWork, IStringLocalizer<CustomResource> sharedResource)
        {
        ...
        {
            var kayitlar = await _unitOfWork.ListeleAsync(k => k.RiskEvreniKod == riskEvreniKod, c => c.RiskKategori);
            if (kayitlar.Count > -1)
            {
        ...
        public async Task<object> TabloDoldurAsync(KullaniciDto kullanan, DataTablesParam dataTablesParam)
        {
            ...
            {
                RiskEvreniRiskKategori aramaObj = Arac.DataTablesAramaNesne<RiskEvreniRiskKategori>(new RiskEvreniRiskKategori(), aramaDegeri);
            ...
            {
                selectData = await _unitOfWork.KosulEkleAsync(selectData, a => a.RiskKategori.Adi.Contains(dataTablesParam.searchValue));
            }
        ...
        /// Sonuc nesnesi döndürür
        /// </returns>
        public async Task<Sonuc> KaydetAsync(KullaniciDto kullanan, RiskEvreniRiskKategori gelenNesne)
        {
            RiskEvreniRiskKategori islemYapilan = new RiskEvreniRiskKategori();
