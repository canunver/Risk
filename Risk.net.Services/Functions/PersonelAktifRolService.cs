...
{
    /// <summary>
    /// PersonelAktifRol iþlemlerinin yapýldýðý servis
    /// </summary>
    public class PersonelAktifRolService : IPersonelAktifRolService
    {
        /// <summary>
        /// IUnitOfWork<PersonelAktifRol> servisine ulaþmak için kullanýlan deðiþken
        /// </summary>
        /// <remarks></remarks>
        ...
        /// <summary>
        /// <see cref="Risk.net.Services.Functions.PersonelAktifRolService" /> 'ýn yeni bir örneðini baþlatan sýnýf
        /// </summary>
