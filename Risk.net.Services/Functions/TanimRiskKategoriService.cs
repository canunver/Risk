...
{
    /// <summary>
    /// TanimRiskKategori iþlemlerinin yapýldýðý servis
    /// </summary>
    public class TanimRiskKategoriService : ITanimRiskKategoriService
    {
        /// <summary>
        /// IUnitOfWork<TanimRiskKategori> servisine ulaþmak için kullanýlan deðiþken
        /// </summary>
        /// <remarks></remarks>
        ...
        /// <summary>
        /// <see cref="Risk.net.Services.Functions.TanimRiskKategoriService" /> 'ýn yeni bir örneðini baþlatan sýnýf
        /// </summary>
