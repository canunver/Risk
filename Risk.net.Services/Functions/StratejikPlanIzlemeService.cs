...
{
    /// <summary>
    /// StratejikPlanIzleme işlemlerinin yapıldığı servis
    /// </summary>
    public class StratejikPlanIzlemeService : IStratejikPlanIzlemeService
    {
        /// <summary>
        /// IUnitOfWork<ViewStratejikPlanIzleme> servisine ulaşmak için kullanılan değişken
        /// </summary>
        /// <remarks></remarks>
        ...
        /// <summary>
        /// <see cref="Risk.net.Services.Functions.StratejikPlanIzlemeService" /> 'ın yeni bir örneğini başlatan sınıf
        /// </summary>
