...
{
    /// <summary>
    /// Dosya iþlemlerinin yapýldýðý servis
    /// </summary>
    public class DosyaService : IDosyaService
    {
        /// <summary>
        /// IUnitOfWork<Dosya> servisine ulaþmak için kullanýlan deðiþken
        /// </summary>
        /// <remarks></remarks>
        ...
        /// <summary>
        /// <see cref="Risk.net.Services.Functions.DosyaService" /> 'ýn yeni bir örneðini baþlatan sýnýf
        /// </summary>
        ...
        public async Task<Sonuc> KaydetAsync(KullaniciDto kullanan, Dosya gelenNesne)
        {
            ...
            if (string.IsNullOrWhiteSpace(gelenNesne.IcerikBase64) && gelenNesne.Icerik == null)
                return new Sonuc(ENUMIslemDurum.Uyari, "Dosya icerik bilgisi boþ");
        ...
        /// <summary>
        /// Istemciden parametere ile gönderilen baðlantý kaydýný silen metod
        /// </summary>
        /// <param name="kullanan"></param>
        /// <param name="baglantiKod"></param>
        /// <returns>
        ...
        /// <summary>
        /// Istemciden parametere ile gönderilen baðlatý kod bilgisini güncelleyen metod
        /// </summary>
        /// <param name="kullanan"></param>
        ...
        /// <summary>
        /// Istemciden parametere ile gönderilen dosya kaydýný silen metod
        /// </summary>
        /// <param name="kullanan"></param>
        /// <param name="kod"></param>
        /// <returns>
        ...
        /// <summary>
        /// Istemciden parametere ile kayda ait dosya sayýsýný döndüren metod
        /// </summary>
        /// <param name="kullanan"></param>
        /// <param name="baglantiKod"></param>
        /// <returns>
