...
{
    /// <summary>
    /// ViewPersonel iþlemlerinin yapýldýðý servis
    /// </summary>
    public class ViewPersonelService : IViewPersonelService
    {
        /// <summary>
        /// IUnitOfWork<ViewPersonel> servisine ulaþmak için kullanýlan deðiþken
        /// </summary>
        /// <remarks></remarks>
        private readonly IUnitOfWork<ViewPersonel> _unitOfWork;
        /// <summary>
        /// IUnitOfWork<ViewPersonelResim> servisine ulaþmak için kullanýlan deðiþken
        /// </summary>
        /// <remarks></remarks>
        ...
        /// <summary>
        /// <see cref="Risk.net.Services.Functions.ViewPersonelService" /> 'ýn yeni bir örneðini baþlatan sýnýf
        /// </summary>
