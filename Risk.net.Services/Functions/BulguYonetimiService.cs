...
{
    /// <summary>
    /// BulguYonetimi iþlemlerinin yapýldýðý servis
    /// </summary>
    public class BulguYonetimiService : IBulguYonetimiService
    {
        ...
        public async Task<object> TabloDoldurAsync(KullaniciDto kullanan, BulguYonetimi kriter, DataTablesParam dataTablesParam)
        {
            ...
            if (aramaDegeri.StartsWith("GELISMIS_ARAMA:"))
            {
                ...
                else if (kriter.SorguDurum > 0)//Ýzleme takip ekranýnda sadece açýk olanlar listelenecek
                {
        ...
        public async Task<Sonuc> KaydetAsync(KullaniciDto kullanan, BulguYonetimi gelenNesne)
        {
            ...
            if (denetimSonuc.IslemSonuc)
            {
                if (denetimSonuc.Nesne != null)
                {
                    ...
                    if (d.Durum == (int)ENUMDurum.GeriGonderildi)//Denetim Tamamlandý
                    {
                        hata += "<li>Denetim Tamamlandýðý için Bulgu kaydýnda deðiþiklik yapýlamaz";
                    }
                }
            }
            else
                hata += "Denetim kaydýna ulaþýlamadý";
        ...
        public async Task<Sonuc> DurumDegistirAsync(KullaniciDto kullanan, BulguYonetimi gelenNesne)
        {
            ...
            try
            {
                ...
                {
                    denetimDurum = (int)ENUMDurum.GeriGonderildi;//Denetim Kapalý
                }
        ...
        /// <summary>
        /// Istemciden parametere ile gönderilen nihayi görüþ bilgilerini kaydeden metod
        /// </summary>
        /// <param name="kullanan"></param>
        /// <param name="gelenNesne"></param>
        /// <returns>
