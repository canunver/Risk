...
{
    /// <summary>
    /// StratejikPlanEylemPlani iþlemlerinin yapýldýðý servis
    /// </summary>
    public class StratejikPlanEylemPlaniService : IStratejikPlanEylemPlaniService
    {
        /// <summary>
        /// IUnitOfWork<StratejikPlanEylemPlani> servisine ulaþmak için kullanýlan deðiþken
        /// </summary>
        /// <remarks></remarks>
        ...
        /// <summary>
        /// <see cref="Risk.net.Services.Functions.StratejikPlanEylemPlaniService" /> 'ýn yeni bir örneðini baþlatan sýnýf
        /// </summary>
        ...
        public async Task<Sonuc> KaydetAsync(KullaniciDto kullanan, StratejikPlanHedef gelenNesne)
        {
            ...
            try
            {
                ...
                tarihce.IlgiKod = gelenNesne.Kod + "iz";//Tarihçe izleme kod kaydýna göre tutulduðu için
