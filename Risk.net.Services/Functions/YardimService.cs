...
{
    /// <summary>
    /// Yardim iþlemlerinin yapýldýðý servis
    /// </summary>
    public class YardimService : IYardimService
    {
        /// <summary>
        /// IUnitOfWork<Yardim> servisine ulaþmak için kullanýlan deðiþken
        /// </summary>
        /// <remarks></remarks>
        ...
        /// <summary>
        /// <see cref="Risk.net.Services.Functions.YardimService" /> 'ýn yeni bir örneðini baþlatan sýnýf
        /// </summary>
