...
{
    /// <summary>
    /// OlayRaporlamaRisk iþlemlerinin yapýldýðý servis
    /// </summary>
    public class OlayRaporlamaRiskService : IOlayRaporlamaRiskService
    {
        /// <summary>
        /// IUnitOfWork<OlayRaporlamaRisk> servisine ulaþmak için kullanýlan deðiþken
        /// </summary>
        /// <remarks></remarks>
        ...
        /// <summary>
        /// <see cref="Risk.net.Services.Functions.OlayRaporlamaRiskService" /> 'ýn yeni bir örneðini baþlatan sýnýf
        /// </summary>
