...
{
    /// <summary>
    /// RiskAzaltmaPlaniNot işlemlerinin yapıldığı servis
    /// </summary>
    public class RiskAzaltmaPlaniNotService : IRiskAzaltmaPlaniNotService
    {
        /// <summary>
        /// IUnitOfWork<RiskAzaltmaPlaniNot> servisine ulaşmak için kullanılan değişken
        /// </summary>
        /// <remarks></remarks>
        ...
        /// <summary>
        /// <see cref="Risk.net.Services.Functions.RiskAzaltmaPlaniNotService" /> 'ın yeni bir örneğini başlatan sınıf
        /// </summary>
