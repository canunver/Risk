...
{
    /// <summary>
    /// Mail Tarihce işlemlerinin yapıldığı servis
    /// </summary>
    public class MailTarihceService : IMailTarihceService
    {
        /// <summary>
        /// IUnitOfWork<MailTarihce> servisine ulaşmak için kullanılan değişken
        /// </summary>
        /// <remarks></remarks>
        ...
        /// <summary>
        /// <see cref="Risk.net.Services.Functions.MailTarihceService" /> 'ın yeni bir örneğini başlatan sınıf
        /// </summary>
