...
{
    /// <summary>
    /// BilgiMerkezi iþlemlerinin yapýldýðý servis
    /// </summary>
    public class BilgiMerkeziService : IBilgiMerkeziService
    {
        /// <summary>
        /// IUnitOfWork<BilgiMerkezi> servisine ulaþmak için kullanýlan deðiþken
        /// </summary>
        /// <remarks></remarks>
        ...
        /// <summary>
        /// <see cref="Risk.net.Services.Functions.BilgiMerkeziService" /> 'ýn yeni bir örneðini baþlatan sýnýf
        /// </summary>
        ...
        public async Task<Sonuc> KaydetAsync(KullaniciDto kullanan, BilgiMerkezi gelenNesne)
        {
            ...
            try
            {
                ...
                {
                    //Revize iþlemi yapýlýyorsa ilk önce eski kaydý pasif yap
