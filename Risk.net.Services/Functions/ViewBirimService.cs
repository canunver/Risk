...
{
    /// <summary>
    /// ViewBirim iþlemlerinin yapýldýðý servis
    /// </summary>
    public class ViewBirimService : IViewBirimService
    {
        /// <summary>
        /// IUnitOfWork<ViewBirim> servisine ulaþmak için kullanýlan deðiþken
        /// </summary>
        /// <remarks></remarks>
        ...
        /// <summary>
        /// <see cref="Risk.net.Services.Functions.SurecService" /> 'ýn yeni bir örneðini baþlatan sýnýf
        /// </summary>
        ...
        {
            //birimKontrolu : Birimi olmayan koordinatörlük ile iþlem yapýldýðýnda
