...
{
    /// <summary>
    /// DenetimDenetci iþlemlerinin yapýldýðý servis
    /// </summary>
    public class DenetimDenetciService : IDenetimDenetciService
    {
        /// <summary>
        /// IUnitOfWork<DenetimDenetci> servisine ulaþmak için kullanýlan deðiþken
        /// </summary>
        /// <remarks></remarks>
        ...
        /// <summary>
        /// <see cref="Risk.net.Services.Functions.DenetimDenetciService" /> 'ýn yeni bir örneðini baþlatan sýnýf
        /// </summary>
