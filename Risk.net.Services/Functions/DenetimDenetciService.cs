...
{
    /// <summary>
    /// DenetimDenetci işlemlerinin yapıldığı servis
    /// </summary>
    public class DenetimDenetciService : IDenetimDenetciService
    {
        /// <summary>
        /// IUnitOfWork<DenetimDenetci> servisine ulaşmak için kullanılan değişken
        /// </summary>
        /// <remarks></remarks>
        private readonly IUnitOfWork<DenetimDenetci> _unitOfWork;
        /// <summary>
        ...
        /// <summary>
        /// <see cref="Risk.net.Services.Functions.DenetimDenetciService" /> 'ın yeni bir örneğini başlatan sınıf
        /// </summary>
        /// <param name="unitOfWork"></param>
        /// <param name="sharedResource"></param>
        /// <remarks></remarks>
        public DenetimDenetciService(IUnitOfWork<DenetimDenetci> unitOfWork, IStringLocalizer<CustomResource> sharedResource)
        {
        ...
        /// Sonuc nesnesi döndürür
        /// </returns>
        public async Task<Sonuc> KaydetAsync(KullaniciDto kullanan, DenetimDenetci gelenNesne)
        {
            DenetimDenetci islemYapilan = new DenetimDenetci();
        ...
        public async Task<Sonuc> SilAsync(KullaniciDto kullanan, string kod)
        {
            ...
            try
            {
                await _unitOfWork.SilAsync(d => d.DenetimKod == kod);
                await _unitOfWork.KaydetAsync();
            }
            catch (System.Exception ex)
            {
