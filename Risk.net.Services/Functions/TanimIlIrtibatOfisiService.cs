...
{
    /// <summary>
    /// TanimIlIrtibatOfisiService iþlemlerinin yapýldýðý servis
    /// </summary>
    public class TanimIlIrtibatOfisiService : ITanimIlIrtibatOfisiService
    {
        /// <summary>
        /// IUnitOfWork<TanimIlIrtibatOfisi> servisine ulaþmak için kullanýlan deðiþken
        /// </summary>
        /// <remarks></remarks>
        private readonly IUnitOfWork<TanimIlIrtibatOfisi> _unitOfWork;
        /// <summary>
        ...
        /// <summary>
        /// <see cref="Risk.net.Services.Functions.TanimIlIrtibatOfisiService" /> 'ýn yeni bir örneðini baþlatan sýnýf
        /// </summary>
        /// <param name="unitOfWork"></param>
        /// <param name="sharedResource"></param>
        /// <remarks></remarks>
        public TanimIlIrtibatOfisiService(IUnitOfWork<TanimIlIrtibatOfisi> unitOfWork, IStringLocalizer<CustomResource> sharedResource)
        {
        ...
        public async Task<object> TabloDoldurAsync(KullaniciDto kullanan, DataTablesParam dataTablesParam)
        {
            ...
            {
                TanimIlIrtibatOfisi aramaObj = Arac.DataTablesAramaNesne<TanimIlIrtibatOfisi>(new TanimIlIrtibatOfisi(), aramaDegeri);
        ...
        /// Sonuc nesnesi döndürür
        /// </returns>
        public async Task<Sonuc> KaydetAsync(KullaniciDto kullanan, TanimIlIrtibatOfisi gelenNesne)
        {
            TanimIlIrtibatOfisi islemYapilan = new TanimIlIrtibatOfisi();
            ...
            try
            {
                ...
                if (string.IsNullOrWhiteSpace(gelenNesne.Kod))
                {
                    ...
                    if (kontrol.IslemSonuc)
                    {
                        ...
                        {
                            hata = "Daha önce kaydedilmiþ. Ayný isimde kayýt yapamazsýnýz.";
                            return new Sonuc(ENUMIslemDurum.Uyari, hata);
                        }
                    }
        ...
        /// Sonuc nesnesi döndürür
        /// </returns>
        public async Task<Sonuc> DurumDegistirAsync(KullaniciDto kullanan, TanimIlIrtibatOfisi gelenNesne)
        {
            TanimIlIrtibatOfisi islemYapilan = new TanimIlIrtibatOfisi();
        ...
        /// <summary>
        /// Istemciden parametere ile talep edilen bilgilere göre kayýt listesisi döndüren metod
        /// </summary>
        /// <param name="kullanan"></param>
