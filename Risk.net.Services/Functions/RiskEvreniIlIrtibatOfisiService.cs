...
{
    /// <summary>
    /// RiskEvreniRiskKategori işlemlerinin yapıldığı servis
    /// </summary>
    public class RiskEvreniIlIrtibatOfisiService : IRiskEvreniIlIrtibatOfisiService
    {
        /// <summary>
        /// IUnitOfWork<RiskEvreniRiskKategori> servisine ulaşmak için kullanılan değişken
        /// </summary>
        /// <remarks></remarks>
        private readonly IUnitOfWork<RiskEvreniIlIrtibatOfisi> _unitOfWork;
        /// <summary>
        ...
        /// <summary>
        /// <see cref="Risk.net.Services.Functions.RiskEvreniIlIrtibatOfisiService" /> 'ın yeni bir örneğini başlatan sınıf
        /// </summary>
        /// <param name="unitOfWork"></param>
        /// <param name="sharedResource"></param>
        /// <remarks></remarks>
        public RiskEvreniIlIrtibatOfisiService(IUnitOfWork<RiskEvreniIlIrtibatOfisi> unitOfWork, IStringLocalizer<CustomResource> sharedResource)
        {
        ...
        /// Sonuc nesnesi döndürür
        /// </returns>
        public async Task<Sonuc> ListeleAsync(KullaniciDto kullanan, string riskEvreniKod)
        {
            var kayitlar = await _unitOfWork.ListeleAsync(k => k.RiskEvreniKod == riskEvreniKod, c => c.IlIrtibatOfisi);
            if (kayitlar.Count > -1)
            {
        ...
        public async Task<object> TabloDoldurAsync(KullaniciDto kullanan, DataTablesParam dataTablesParam)
        {
            ...
            {
                RiskEvreniIlIrtibatOfisi aramaObj = Arac.DataTablesAramaNesne<RiskEvreniIlIrtibatOfisi>(new RiskEvreniIlIrtibatOfisi(), aramaDegeri);
            ...
            {
                selectData = await _unitOfWork.KosulEkleAsync(selectData, a => a.IlIrtibatOfisi.Adi.Contains(dataTablesParam.searchValue));
            }
        ...
        /// Sonuc nesnesi döndürür
        /// </returns>
        public async Task<Sonuc> KaydetAsync(KullaniciDto kullanan, RiskEvreniIlIrtibatOfisi gelenNesne)
        {
            RiskEvreniIlIrtibatOfisi islemYapilan = new RiskEvreniIlIrtibatOfisi();
