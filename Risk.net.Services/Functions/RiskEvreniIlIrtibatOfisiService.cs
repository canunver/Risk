...
{
    /// <summary>
    /// RiskEvreniRiskKategori iþlemlerinin yapýldýðý servis
    /// </summary>
    public class RiskEvreniIlIrtibatOfisiService : IRiskEvreniIlIrtibatOfisiService
    {
        /// <summary>
        /// IUnitOfWork<RiskEvreniRiskKategori> servisine ulaþmak için kullanýlan deðiþken
        /// </summary>
        /// <remarks></remarks>
        ...
        /// <summary>
        /// <see cref="Risk.net.Services.Functions.RiskEvreniIlIrtibatOfisiService" /> 'ýn yeni bir örneðini baþlatan sýnýf
        /// </summary>
