...
{
    /// <summary>
    /// RiskAzaltmaPlaniIliski işlemlerinin yapıldığı servis
    /// </summary>
    public class RiskAzaltmaPlaniIliskiService : IRiskAzaltmaPlaniIliskiService
    {
        /// <summary>
        /// IUnitOfWork<RiskAzaltmaPlaniIliski> servisine ulaşmak için kullanılan değişken
        /// </summary>
        /// <remarks></remarks>
        ...
        /// <summary>
        /// <see cref="Risk.net.Services.Functions.RiskAzaltmaPlaniIliskiService" /> 'ın yeni bir örneğini başlatan sınıf
        /// </summary>
