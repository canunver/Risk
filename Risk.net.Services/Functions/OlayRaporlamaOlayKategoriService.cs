...
{
    /// <summary>
    /// OlayRaporlamaOlayKategori iþlemlerinin yapýldýðý servis
    /// </summary>
    public class OlayRaporlamaOlayKategoriService : IOlayRaporlamaOlayKategoriService
    {
        /// <summary>
        /// IUnitOfWork<OlayRaporlamaOlayKategori> servisine ulaþmak için kullanýlan deðiþken
        /// </summary>
        /// <remarks></remarks>
        ...
        /// <summary>
        /// <see cref="Risk.net.Services.Functions.OlayRaporlamaOlayKategoriService" /> 'ýn yeni bir örneðini baþlatan sýnýf
        /// </summary>
