...
{
    /// <summary>
    /// DenetimSorumlu iþlemlerinin yapýldýðý servis
    /// </summary>
    public class DenetimSorumluService : IDenetimSorumluService
    {
        /// <summary>
        /// IUnitOfWork<DenetimSorumlu> servisine ulaþmak için kullanýlan deðiþken
        /// </summary>
        /// <remarks></remarks>
        ...
        /// <summary>
        /// <see cref="Risk.net.Services.Functions.DenetimSorumluService" /> 'ýn yeni bir örneðini baþlatan sýnýf
        /// </summary>
