...
{
    /// <summary>
    /// OrtakService işlemlerinin yapıldığı servis
    /// </summary>
    public class OrtakService
    {

        /// <summary>
        /// Istemciden parametre ile talep edilen bilgilere ait birim koşulunu döndüren metod
        /// </summary>
        ...
        /// <returns>
        /// string türünde koşul bilgisi döndürür
        /// </returns>
        public static async Task<string[]> ListeleBirimKosulAsync(KullaniciDto kullanan, ICTEKoordinatorlukService serviceCTE, string tur, string koordinatorlukKod, string birimKod)
        {
            ...
            else if (Arac.YetkisiVarmi("GENELKOORDINATOR", kullanan))
            {
                ...
                {
                    //Kriter olarak verilen koordinatörlük görmeye yetkili değilse koşula ekleme
            ...
            {
                kosul[0] = kullanan.KoordinatorlukKod;//kendi Koordinatörlüğü
                if (!string.IsNullOrWhiteSpace(birimKod))
                    kosul[1] = birimKod;
            }
