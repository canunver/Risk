...
{
    /// <summary>
    /// StratejikPlanHedefGosterge iþlemlerinin yapýldýðý servis
    /// </summary>
    public class StratejikPlanHedefGostergeService : IStratejikPlanHedefGostergeService
    {
        /// <summary>
        /// IUnitOfWork<StratejikPlanHedefGosterge> servisine ulaþmak için kullanýlan deðiþken
        /// </summary>
        /// <remarks></remarks>
        ...
        /// <summary>
        /// IStratejikPlanIzlemeDonemService servisine ulaþmak için kullanýlan deðiþken
        /// </summary>
        /// <remarks></remarks>
        ...
        /// <summary>
        /// <see cref="Risk.net.Services.Functions.StratejikPlanHedefGostergeService" /> 'ýn yeni bir örneðini baþlatan sýnýf
        /// </summary>
        ...
        public async Task<Sonuc> KaydetAsync(KullaniciDto kullanan, StratejikPlanHedefGosterge gelenNesne)
        {
            ...
            try
            {
                ...
                //Etki deðeri 100 den büyük kontrolü
                ...
                if (string.IsNullOrWhiteSpace(gelenNesne.Kod) || gelenNesne.Kod.IndexOf("dtabloYeni_") > -1)
                {
                    ...
                    //Numara alma iþleminde Hedef Numarasýný aldýðý için
                    //*****************************************************************
        ...
        public async Task<Sonuc> KaydetIzlemeAsync(KullaniciDto kullanan, StratejikPlanHedefGosterge gelenNesne)
        {
            ...
            try
            {
                ...
                //Dönem bilgisinin kayýt edilmesi
                //Eskiden kayýt edilen varsa silinsin
                ...
                tarihce.IlgiKod = gelenNesne.StratejikPlanHedefKod + "iz";//Tarihçe izleme kod kaydýna göre tutulduðu için
