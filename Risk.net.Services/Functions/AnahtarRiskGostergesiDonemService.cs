...
{
    /// <summary>
    /// AnahtarRiskGostergesiDonem işlemlerinin yapıldığı servis
    /// </summary>
    public class AnahtarRiskGostergesiDonemService : IAnahtarRiskGostergesiDonemService
    {
        /// <summary>
        /// IUnitOfWork<AnahtarRiskGostergesiDonem> servisine ulaşmak için kullanılan değişken
        /// </summary>
        ...
        /// <summary>
        /// <see cref="Risk.net.Services.Functions.AnahtarRiskGostergesiDonemService" /> 'ın yeni bir örneğini başlatan sınıf
        /// </summary>
