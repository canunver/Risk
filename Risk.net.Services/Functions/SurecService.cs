...
{
    /// <summary>
    /// Surec iþlemlerinin yapýldýðý servis
    /// </summary>
    public class SurecService : ISurecService
    {
        /// <summary>
        /// IUnitOfWork<Surec> servisine ulaþmak için kullanýlan deðiþken
        /// </summary>
        /// <remarks></remarks>
        ...
        public async Task<Sonuc> KaydetAsync(KullaniciDto kullanan, Surec gelenNesne)
        {
            ...
            try
            {
                ...
                //Koordinatörlük, Birim ve Süreç bilgileri ayný olan kayýt eklenmemeli.
