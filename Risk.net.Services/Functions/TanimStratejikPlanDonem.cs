...
{
    /// <summary>
    /// TanimStratejikPlanDonemService iþlemlerinin yapýldýðý servis
    /// </summary>
    public class TanimStratejikPlanDonemService : ITanimStratejikPlanDonemService
    {
        /// <summary>
        /// IUnitOfWork<StratejikPlanDonem> servisine ulaþmak için kullanýlan deðiþken
        /// </summary>
        /// <remarks></remarks>
        ...
        /// <summary>
        /// <see cref="Risk.net.Services.Functions.TanimStratejikPlanDonemService" /> 'ýn yeni bir örneðini baþlatan sýnýf
        /// </summary>
